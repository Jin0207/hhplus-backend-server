...
public record Payment(
     ...
     * 결제 생성
     */
    public static Payment create(Long orderId, Long userId, Integer price, String paymentType) {
     ...
     * 결제 완료
     */
    public Payment complete(PaymentType paymentType, String transactionId, String paymentGateway, boolean externalSync) {
